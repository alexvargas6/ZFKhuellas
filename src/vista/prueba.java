...
import pruebazfk.EscribirMapaBit;
import búsqueda.Identificación;
...
//la altura de la imagen de la huella digital
        ...
        public void run() {
            ...
            while (!mbStop) {//Si mbStop es true esta cerrado si es false esta abierto.
                ...
                if (0 == (ret = FingerprintSensorEx/*Es la clase que se usa para 
                                conectar con los dispositivos de huella*/.AcquireFingerprint/*Se usa para extraer la huella digital*/(mhDispositivo/*Nuestro dispositivo*/, imgbuf/*Datos de la imagen(Ancho y alto)*/,
    ...
    {    //re1 = new Registro();
        if (getRegister())//Si bRegister es true, se esta usando el botón de registrar
        {
        ...
        } else if (bIdentify)/*bIdentify es true, entonces no se ha usado el botón de verificar.
                                    Si bIdentify es true significa que se esta usando el botón de identiciar, ya
                                    que este devuelve true como valor.*/ /*Esta función identifica las huellas registradas y te dice cual fue la huella que se 
            ...
            ident.identificarUsuario(mhDB, template, btnFoto, btnImg, lblID, lblIDMostrar,
                    lblNombre, lblNombreMostrar);
                                    ...
                                    Ya que verificar devuelve false como valor*/ /*La función verificación sirve para verificar si el e identificar al último
                                    Usuario registrado.*/ if (re1.getLongitudPlantillaTemporal() <= 0)//Si registro e identificación son false
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lblBuscar, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(0, 0, Short.MAX_VALUE))))
        );
