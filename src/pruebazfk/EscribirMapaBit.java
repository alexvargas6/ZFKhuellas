...
//import static pruebazfk.prueba.changeByte;
//import static pruebazfk.prueba.intToByteArray;

/**
 *
 * @author manuel.vargas
 */
public class EscribirMapaBit {
    ...
    public static void writeBitmap(byte[] imageBuf, int nWidth, int nHeight,
        ...
        try ( //FileOutputStream nos dice en que dato vamos a escribir (path)
...
Se genera un espacio en la memoria interna entre el programa y su copia.*/
        ...
        } //Esta linea crea el archivo huella.mpb
//DataOutputStream escribe el dato que FileOutputStream nos da, y lo hace utilizando el metodo write.
