...
public class Identificación{
    ...
    public void identificarUsuario(long mhDB,byte[] template,JButton btnFoto,JButton btnImg,JLabel lblfoto
    ,JLabel lblIDMostrar, JLabel lblNombre, JLabel lblNombreMostrar) throws InterruptedException, IOException, SQLException, ClassNotFoundException{
    ...
    prueba prueba = new prueba();
                    ...
                    if (ret == 0)
                        //Cuando ret es igual a 0 la identificación es correcta
                    {
