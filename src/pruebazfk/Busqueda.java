...
setIdEnMemoria(0);
        ...
        }catch(Exception e){System.out.println("Problema al tratar de identificar al usuario:\n" + e); }
              finally
        {
        try{
        pru.closeCon();
 ...
 JOptionPane.showMessageDialog(null, "Ocurrio un error al contar los usuarios en memoria: " + ret);
        ...
        try{
        prueba.closeCon();
        }catch(Exception e){System.out.println("Problemas al tratar de cerrar la conexión\n"+e);}
        }
    }
    }
    
    
    public void mostrarlbl(JLabel lblfoto,JLabel lblIDmostrar
    ,JLabel lblNombre,JLabel lblNombreMostrar){
   ...
   Image us= null;//Nuestra imagén en donde almacenaremos nuestro blob convertido en imagén
    ...
    pru.closeCon();//Cerramos la conexión después del finally
        }catch(Exception e){System.out.println("Error al tratar de cerrar la conexión:\n" + e);
        }
